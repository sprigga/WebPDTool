...
| **最新更新** | 2026-03-17 - 時區統一至 Asia/Taipei、新增 `wall_time_ms` 欄位、`measured_value` 改為 Text 型態、AsyncSession 全面遷移 |
...
**最後更新**: 2026-03-17 | **版本**: v0.7.0 | **狀態**: 核心功能完整，Async SQLAlchemy 遷移完成，Modbus 整合完成，27 種儀器驅動，13 種測量模板，12 個視圖（10 個完整），Asia/Taipei 時區統一，生產就緒版本
